...
_IP_TO_DC: Dict[str, Tuple[int, bool]] = {
    ...
    # добавленные IP из логов / Америка
    '149.154.167.35': (2, False), '149.154.167.255': (2, False),
    '149.154.167.30': (2, False), '149.154.167.36': (2, False),

    # DC3
    '149.154.175.100': (3, False), '149.154.175.101': (3, False),
    '149.154.175.102': (3, True),
    # добавленные IP из логов / Америка
    '149.154.175.211': (3, False), '149.154.175.212': (3, False),
    ...
    # добавленные IP / Амстердам
    '149.154.167.100': (4, False), '149.154.167.101': (4, False),
    '149.154.166.200': (4, False),
